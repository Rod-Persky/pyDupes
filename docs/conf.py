...
project = 'pyDupes'
copyright = '%s, Rodney Persky / Free as in Freedom' %time.strftime('%Y')
...
latex_documents = [
  ('pages/index', '{}.tex'.format(project.replace(" ", "")), project,
...
man_pages = [
    ('pages/index', project.replace(" ", ""), project,
     ['Rodney Persky'], 1)
]
...
texinfo_documents = [
  ('pages/index', project.replace(" ", ""), project,
   'Rodney Persky', dir_menu, description,
   category),
]
